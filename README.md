...
## Description
This repository contains 01 bash script, that will help you set up:
...
\# After cloning the repository from Github, copy the script file to Home directory
> **cd** *./csv-open-eda/* && **cp** *./auto_eda_setup.sh ~ \
> **cd** ~

\# Run the following command, *super-user permission is required*\
\# Sit back and wait for the script to finish.
> **sudo** **bash** -x *auto_eda_setup.sh* | **tee** *auto_eda_setup.log*
